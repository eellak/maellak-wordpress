        ...
        <div class="row-fluid login dropdown yamm-fullwidth open dropdown-toggle">
    		<div class="span12">
                <div class="yamm-content">
                  ...
                  <div class="row-fluid">
      <form class="class="form-horizontal span12" id="myform" ACTION="register_save.php" METHOD=post>
	      <fieldset class="form-vertical span4 offset4">

		<label for="username1">Ονομα (*)</label>
		<input name="username1" id="username1" type="text" class="input-block-level"><span id="username1Info"></span><br/>
