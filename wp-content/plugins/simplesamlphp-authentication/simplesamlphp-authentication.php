				...
				if ($simplesaml_authentication_opt['new_user'] == 1) {
					...
					if(empty($simplesaml_authentication_opt['lastname_attribute'])) {
						...
						$user_info['last_name'] = $attributes[$simplesaml_authentication_opt['lastname_attribute']][0];
                                        ...
                                        if(empty($simplesaml_authentication_opt['foreas_attribute'])) {
                                                $user_info['description'] = $attributes['sn'][0];
                                        } else {
                                                $user_info['description'] = $attributes[$simplesaml_authentication_opt['foreas_attribute']][0];
                                        }
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<span class="setting-description">Default is "mail".</span> 
                ...
                <tr valign="top">
                <th scope="row"><label for="foreas_attribute">Attribute to be used as FOREAS</label></th>
                <td><input type="text" name="foreas_attribute" id="foreas_attribute_inp" value="<?php echo $options['foreas_attribute']; ?>" size="35" />
                <span class="setting-description">Default is "foreas".</span>
                </td>
        </tr>
