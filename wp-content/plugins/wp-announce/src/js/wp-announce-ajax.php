...
$wpa_post_id = $_REQUEST['wpa_post_id'];
...
if($wpa_thumbnail_id != ""){
	$wpa_bg_style = "background:url(" . $wpa_bg . ") center center no-repeat !important;";}
...
<?php if($_REQUEST['wpa_c'] == "no"){ }else{ ?>
       wpa_set_cookie_array("wpa_<?php echo $wpa_post_id ?>","<?php echo $wpa_post_id ?>","<?php echo date('d-m-Y'); ?>", 1);
<?php } ?>
</script>